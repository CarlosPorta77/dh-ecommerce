...
if ($_POST) {
    ...
    if (count($arrayErrores) == 0) {
        // almacenamos usuario
        $usuario = new Usuario($_POST["nombre"], $_POST["apellido"], $_POST["telefono"], $_POST["celular"], $_POST["direccion"], $_POST["barrio"], $_POST["email"], $_POST["password"]);
              ...
              <div class="col-md-10  col-md-offset-1 form-register">
                ...
                <form id="form_register" action="register.php" method="POST" enctype="multipart/form-data">
                  ...
                  <div class="form-group">
                    ...
                    <input id="nombre" placeholder="Ingresa tu nombre" class="form-control" type="text" name="nombre"
                           value="<?=$nombreDefault?>">
                  ...
                  <div class="form-group">
                    ...
                    <input id="apellido" placeholder="Ingresa tu apellido" class="form-control" type="text"
                           name="apellido" value="<?=$apellidoDefault?>">
                  ...
                  <div class="form-group">
                    ...
                    <input id="telefono"
                           placeholder="Ingresa tu número de telefono de linea. Si es larga distancia anteponer el prefijo."
                           class="form-control" type="text" name="telefono" value="<?=$telefonoDefault?>">
                  ...
                  <div class="form-group">
                    ...
                    <input id="celular"
                           placeholder="Ingresa tu número de telefono movil. Si es larga distancia anteponer el prefijo."
                           class="form-control" type="text" name="celular" value="<?=$celularDefault?>">
                  ...
                  <div class="form-group">
                    ...
                    <input id="direccion" placeholder="Ingresa dirección : Calle  Número  -  Piso  Depto"
                           class="form-control" type="text" name="direccion" value="<?=$direccionDefault?>">
                  ...
                  <div class="form-group">
                    ...
                    <input id="barrio" placeholder="Ingresa barrio/localidad" class="form-control" type="text"
                           name="barrio" value="<?=$barrioDefault?>">
                  ...
                  <div class="form-group">
                    ...
                    <input id="email" placeholder="Ingresa tu email" class="form-control" type="text" name="email"
                           value="<?=$emailDefault?>">
                  ...
                  <div class="form-group">
                    ...
                    <input id="password" placeholder="Ingresa password. Debe ser mayor a 8 caracteres"
                  ...
                  <div class="form-group">
                    ...
                    <input id="confirmpsw" class="form-control" placeholder="Confirma tu password" type="password"
