...
<html lang="es">
  ...
  <head>
    ...
    <title>Sushi Furusato Sushi Delivery</title>
      ...
      <div class="container">
        ...
        <div id="navbar" class="collapse navbar-collapse">
          ...
          <?php if ($auth->estaLogueado()) : ?>
            <a type="button" class="btn btn-primary" href="profile.php"><?= $auth->usuarioLogueado($db)->getNombre()?></a>
          ...
          <?php endif; ?>
          <a href="cart.php">
            <i class="fa fa-shopping-cart fa-2x" aria-hidden="true"><span class="badge badge-cart">0</span></i></a>
        </div>
      </div>
    </nav>
    <!--/.nav-collapse -->
